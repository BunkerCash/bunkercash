...
export const transactionsAtom = atom<Transaction[]>([
  {
    ...
    metadata: {
      ...
      description:
        "BunkerCash purchased 24-unit apartment complex via overcollateralized acquisition. Purchase price: $450k. Current market value: $680k (150% collateral ratio). Expected rental yield: 7.5% annually.",
      collateralRatio: "150%",
  ...
  },
  {
    ...
    metadata: {
      ...
      description:
        "Monthly rental income from BunkerCash-owned beachfront condo. Purchased for $280k, current value: $405k (145% collateral). Current occupancy: 100%. Monthly rent collected: $3,800.",
      collateralRatio: "145%",
  ...
  },
  {
    ...
    metadata: {
      ...
      description:
        "BunkerCash acquired duplex property with cash purchase. Acquisition cost: $320k. Post-renovation market value projection: $512k (160% collateral ratio). Expected completion: Q1 2026.",
      collateralRatio: "160%",
