        ...
        <div className="rounded-xl border border-neutral-800/60 bg-neutral-900/40 p-6">
          <div className="mb-4">
            ...
            <p className="mt-1 text-xs text-neutral-500">
              ...
              records a withdrawal without changing net asset value or the reference rate.
            </p>
          </div>
        ...
        <div className="rounded-xl border border-neutral-800/60 bg-neutral-900/40 p-6">
          ...
          {repayTarget && (
            <p className="mt-2 text-[11px] text-neutral-500">
              ...
              . Use Profit instead if the returned cash should increase net asset value
        ...
        <div className="rounded-xl border border-neutral-800/60 bg-neutral-900/40 p-6">
          <div className="mb-4">
            ...
            <p className="mt-1 text-xs text-neutral-500">
              ...
              always increases net asset value and does not reduce the withdrawal&apos;s
              remaining balance.
            </p>
          </div>
          ...
          {profitTarget && (
            <p className="mt-2 text-[11px] text-neutral-500">
              ...
              . The submitted amount is treated as pure profit and increases net asset value
              one-for-one.
            </p>
          )}
        ...
        <div className="rounded-xl border border-neutral-800/60 bg-neutral-900/40 p-6">
          <div className="mb-4">
            ...
            <p className="mt-1 text-xs text-neutral-500">
              ...
              vault, closes the selected withdrawal, and adjusts net asset value by the
            ...
            <p className="mt-2 text-[11px] text-neutral-500">
              ...
              {closePnlDelta === null ? (
                ...
                <>
                  ...
                  and increases net asset value by the same amount.
                </>
              ) : closePnlDelta < BigInt(0) ? (
                <>
                  ...
                  and reduces net asset value by the same amount.
                </>
              ) : (
                ". This closes at breakeven with no net asset value change."
              )}
            </p>
          )}
